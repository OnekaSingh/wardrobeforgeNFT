...
export declare class BaseModule {
    ...
    protected requestThirdPartyWallets<ResultType = any, Events extends EventsDefinition = void>(payload: Partial<JsonRpcRequestPayload>): import("../util/promise-tools").PromiEvent<ResultType, Events extends void ? {
        done: (result: ResultType) => void;
        error: (reason: any) => void;
        settled: () => void;
        "closed-by-user": () => void;
    ...
    protected requestOverlay<ResultType = any, Events extends EventsDefinition = void>(payload: Partial<JsonRpcRequestPayload>): import("../util/promise-tools").PromiEvent<ResultType, Events extends void ? {
        done: (result: ResultType) => void;
        error: (reason: any) => void;
        settled: () => void;
        "closed-by-user": () => void;
