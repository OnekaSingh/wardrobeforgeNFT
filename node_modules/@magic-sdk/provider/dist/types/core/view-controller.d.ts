import { MagicIncomingWindowMessage, MagicOutgoingWindowMessage, JsonRpcRequestPayload, MagicMessageEvent, MagicMessageRequest, MagicThirdPartyWalletRequest, MagicThirdPartyWalletEventPayload, MagicThirdPartyWalletResponse, MagicThirdPartyWalletUpdate } from '@magic-sdk/types';
...
export declare abstract class ViewController {
    ...
    post<ResultType = any>(msgType: MagicOutgoingWindowMessage, payload: JsonRpcRequestPayload): Promise<JsonRpcResponse<ResultType>>;
    postThirdPartyWalletResponse(response: MagicThirdPartyWalletResponse['response']): Promise<void>;
    postThirdPartyWalletUpdate(details: MagicThirdPartyWalletUpdate['details']): Promise<void>;
    /**
    ...
    onThirdPartyWalletRequest(handler: (event: MagicThirdPartyWalletRequest) => any): void;
    /**
